...
class Gemma4Router(nn.Module):
    ...
    def __init__(
        ...
        # ReplicatedLinear replaces GateLinear (not available in v0.15.1 & Will Fallback to ReplicatedLinear).
...
class Gemma4Attention(nn.Module):
    def __init__(
        ...
        # NOTE(kunlun): XPU prefill_attention kernel internally applies
        # 1/sqrt(head_dim) unconditionally (ignoring the scaling parameter).
        # We keep scaling=1.0 and compensate by pre-scaling q in forward().
        self.scaling = 1.0
